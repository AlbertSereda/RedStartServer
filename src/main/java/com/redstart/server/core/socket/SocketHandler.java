...
import com.redstart.server.core.socket.message.SocketMessageHandler;
...
public class SocketHandler implements Runnable {
    ...
    //TODO на будущее подумать о разделении на потоки. Принять клиента, отправить данные, принять данные. Посмотреть еще раз видео про NIO
    @Override
    public void run() {
        try {
